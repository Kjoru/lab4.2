...
void transp(int **B,int **T,int M,int N);
...
int main()
{
    ...
    do{
        printf("\nChoose action:\n1.Maximum A \n2.Transpose B\n3.AxB\n4.Sort A\n5.A+B\n");
        scanf("%d",&var_2);
    }while(var_2 != 1 && var_2 != 2 && var_2 != 3 && var_2 != 4 && var_2 != 5);
    system("cls");
    	if(var_2==1) max(A,M,N);
	else if(var_2==2) transp(B,T,M,N);
	else if(var_2==3) prod(A,B,Prod,M,N);
	else if(var_2==4) sort(A,M,N);
	else if(var_2==5) suma(A,B,M,N);
 return 0;
}
